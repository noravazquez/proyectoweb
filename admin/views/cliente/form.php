    ...
    <div class="card mx-4 mx-md-5 shadow-5-strong" style="margin-top: -100px; background: hsla(0, 0%, 100%, 0.8);backdrop-filter: blur(30px);">
        <div class="card-body py-5 px-md-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-5"><?php echo ($action == 'edit') ? 'Modificar ' : 'Nuevo ' ?>cliente</h2>
                    <form class="container-fluid" method="POST" action="cliente.php?action=<?php echo $action; ?>" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <?php if ($action == 'edit'): ?>
                                <input type="hidden" name="data[id_cliente]" value="<?php echo isset($data[0]['id_cliente']) ? $data[0]['id_cliente'] : ''; ?>">
                            <?php endif; ?>
