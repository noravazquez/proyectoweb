    ...
    <div class="card mx-4 mx-md-5 shadow-5-strong" style="margin-top: -100px; background: hsla(0, 0%, 100%, 0.8);backdrop-filter: blur(30px);">
        <div class="card-body py-5 px-md-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <h2 class="fw-bold mb-5"><?php echo ($action == 'edit') ? 'Modificar ' : 'Nuevo ' ?>ropa</h2>
                    <form class="container-fluid" method="POST" action="ropa.php?action=<?php echo $action; ?>" enctype="multipart/form-data">
                        <!-- 2 column grid layout with text inputs for the first and last names -->
                        <div class="form-outline mb-4">
                            <input type="text" name="data[ropa]" class="form-control" value="<?php echo isset($data[0]['ropa']) ? $data[0]['ropa'] : ''; ?>" required minlength="3" maxlength="100"/>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                <select name="data[id_categoria_ropa]" class="form-control" required>
                                <?php
                                    foreach ($data_categoria_ropa as $key => $categoria_ropa): 
                                    $selected = " ";
                                    if ($categoria_ropa['id_categoria_ropa']==$data[0]['id_categoria_ropa']):
                                        $selected = " selected";
                                    endif;?>
                                    <option value="<?php echo $categoria_ropa['id_categoria_ropa']; ?>" <?php echo $selected; ?>><?php echo $categoria_ropa['categoria_ropa']; ?></option>
                                <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                <select name="data[id_marca_ropa]" class="form-control" required>
                                <?php
                                    foreach ($data_marca_ropa as $key => $marca_ropa): 
                                    $selected = " ";
                                    if ($marca_ropa['id_marca_ropa']==$data[0]['id_marca_ropa']):
                                        $selected = " selected";
                                    endif;?>
                                    <option value="<?php echo $marca_ropa['id_marca_ropa']; ?>" <?php echo $selected; ?>><?php echo $marca_ropa['marca_ropa']; ?></option>
                                <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                <select name="data[id_talla_ropa]" class="form-control" required>
                                <?php
                                    foreach ($data_talla_ropa as $key => $talla_ropa): 
                                    $selected = " ";
                                    if ($talla_ropa['id_talla_ropa']==$data[0]['id_talla_ropa']):
                                        $selected = " selected";
                                    endif;?>
                                    <option value="<?php echo $talla_ropa['id_talla_ropa']; ?>" <?php echo $selected; ?>><?php echo $talla_ropa['talla_ropa']; ?></option>
                                <?php endforeach; ?>
                                </select>
                        ...
                        <div class="mb-3">
                            <?php if ($action == 'edit'): ?>
                                <input type="hidden" name="data[id_ropa]" value="<?php echo isset($data[0]['id_ropa']) ? $data[0]['id_ropa'] : ''; ?>">
                            <?php endif; ?>
