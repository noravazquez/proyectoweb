                    ...
                    <div class="col-12 d-flex justify-content-center">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav align-items-center mx-auto">
                                <li class="nav-item">
                                    <a class="nav-link mx-2" href="index_dependiente.php" onmouseover="this.style.backgroundColor='#494949'; this.style.textTransform='uppercase';" onmouseout="this.style.backgroundColor=''; this.style.textTransform='';"><i class="bi bi-house-fill"></i> Home</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mx-2" href="pago.php" onmouseover="this.style.backgroundColor='#494949'; this.style.textTransform='uppercase';" onmouseout="this.style.backgroundColor=''; this.style.textTransform='';">Pago</a>
                                </li>
                                <li class="nav-item dropdown">
