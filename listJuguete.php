...
<body>
    ...
    <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background-image: url('admin/images/banner-juguete.jpg'); background-size: contain;">
        <div class="container py-5">
            <div class="row px-4 px-lg-5">
                <div class="col-lg-6">
                    <p class="text-muted small text-uppercase mb-2">Variedad de juguetes</p>
                    <h1 class="h2 text-uppercase mb-3">Explora entre los diferentes juguetes con los que contamos y encuentra el perfecto para tu bebé.</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                foreach ($data as $key => $juguete) {
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <img src="admin/<?php echo $juguete['imagen']; ?>" alt="<?php echo $juguete['juguete']; ?>">
                            <div class="card-body">
                                <h3 class="card-title"><?php echo $juguete['juguete']; ?></h3>
                                <p class="card-price">$<?php echo $juguete['precio']; ?></p>
                                <a href="detalle_juguete.php?id=<?php echo $juguete['id_juguete']; ?>" class="btn">Ver detalle</a>
                            </div>
                        </div>
                    </div>
                    <?php
