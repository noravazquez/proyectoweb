<?php require_once(__DIR__.'/admin/controllers/sistema.php'); 
      require_once (__DIR__."/admin/controllers/calzado.php"); 
      require_once (__DIR__."/admin/controllers/categoria_calzado.php");
      require_once (__DIR__."/admin/controllers/marca_calzado.php");
      require_once (__DIR__."/admin/controllers/talla_calzado.php");
...
<body>
    ...
    <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background-image: url('admin/images/banner-calzado.jpg'); background-size: contain;">
        ...
        <div class="container">
            <div class="row">
                ...
                foreach ($data as $key => $calzado) {
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <img src="admin/<?php echo $calzado['imagen']; ?>" alt="<?php echo $calzado['calzado']; ?>">
                            <div class="card-body">
